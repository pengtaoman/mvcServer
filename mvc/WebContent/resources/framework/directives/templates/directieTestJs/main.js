...
require.config({
    ...
    paths: {
        "application-configuration": "resources/framework/template/directieTestJs/application-configuration",
        ...
        "framework-directiveTestController": "resources/framework/template/directieTestJs/directiveTestController",
    ...
    shim: {
        ...
        "framework-directiveTestController":["angular"],
