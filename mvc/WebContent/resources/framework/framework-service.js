        ...
        angular.forEach(subM, function(subMe) {
            if (angular.equals(subMe["fParentMenuId"],rid)) {
                ...
                if (hasChild) {
                    ...
                    if (subMe['fPageLink']) {
                        strHtml.push('<li><a href="'+jsContextPath+"views"+subMe['fPageLink']+'"><i class="fa fa-circle-o"></i>'+subMe['fMenuName']+'</a>');
                    } else {
        ...
        getMenuHtml : function(rootMenu, subMenu) {
            ...
            angular.forEach(rootMenu, function(rmu) {
                ...
                if (hasChild) {
                    ...
                    if(rmu["fPageLink"]) {
                        strHtml.push('         <a href="'+jsContextPath+"views"+rmu["fPageLink"]+'">');
                    } else {
                        strHtml.push('         <a href="javascript:void(0);">');
                    }
