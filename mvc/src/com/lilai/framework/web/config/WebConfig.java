...
import com.lilai.framework.web.resolver.TDPDViewResolver;
//import com.lilai.framework.web.resolver.TDTilesViewResolver;
import com.lilai.framework.web.view.TDPDFView;
...
@ComponentScan(basePackages = {"${base.framework.package}", "${business.base.packages}"},useDefaultFilters=false,
