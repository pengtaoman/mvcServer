 ...
 */
package com.neusoft.tdframework.bas.log;
...
public class BASLogFilter extends TDDispatchAction{
	...
	public ActionForward log(ActionMapping actionMapping,
        ...
        session.removeAttribute("cur_menuId");
        session.setAttribute("cur_menuId", menuId);
        String clickTimes = (String)session.getAttribute("click_times");
        if(clickTimes==null){
            session.setAttribute("click_times", "1");
        }else{
        	int temp = Integer.parseInt(clickTimes)+1;
            session.setAttribute("click_times", String.valueOf(temp));
        }
