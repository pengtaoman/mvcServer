...
public class OldSVGCreateFactory {
	...
	private Hashtable actInstIDs = new Hashtable();
	private Hashtable subProc = new Hashtable();
	private Hashtable overtimeInfo=new Hashtable();
	...
	public  String createProcessDefine(HttpServletRequest request,NWSession session,String path,String pathimg) throws NWException{
		...
		String procinstid=(String)httpsession.getAttribute("procinstid");
        ...
        sb.append(this.createHeader(maxX,maxY,path));
			...
			for (int i=0;i<activities.size();i++){
	            ...
	            sb.append(this.createActivitie(process,apps,states,actInstIDs,subProc,actdef,pathimg,path));  
			}
			for (int i=0;i<activities.size();i++){
				NWActDef actdef = (NWActDef)activities.elementAt(i);
	            sb.append(this.createActivitieName(states,actInstIDs,subProc,actdef));  
			}
	...
	private String createActivitie(NWProcDef process,Hashtable apps,Hashtable states,Hashtable actinst,
			Hashtable subproc,NWActDef actdef,String path,String Contextpath)throws NWException{
		   StringBuffer sb = new StringBuffer();
		   String apptype = "";
		   ...
		   String recID = htID;
		   if (actinst.get(actdef.getID())!=null){
			   htID = (String)actinst.get(actdef.getID());
		   }
		   String subprocinstid = "none";
		   if (subproc.get(actdef.getID())!=null)
		   ...
		   if (type==0){
			   ...
			   sb.append("<g onmouseover=\"byRecSelected('0',evt,'").append(recID)
			     ...
			     .append(" onmouseout=\"unOldRecSelected(evt,'").append("rec"+recID).append("','")
               .append(Contextpath).append("')\"").append(tab)
			   ...
			   sb.append("<rect x=\"").append(x).append("\" y=\"").append(y)
			     .append("\" width=\"41\" height=\"41\" style=\"fill:")
			     .append(color).append(";fill-opacity: 0.6;\" ")
			     .append("id=\"").append("rec"+recID).append("\"/>")
			     .append(tab);
			   String png = "auto.png";
		   ...
		   if (type==1){
			   ...
			   if (state!=null && state.equals("1")){
				   sb.append("<g onmouseover=\"byRunManualRecSelected('1',evt,'").append(recID)
				     .append("','").append(htID).append("','")
				     .append(Contextpath).append("')\"").append(tab)
				     .append(" onmouseout=\"unOldRecSelected(evt,'").append("rec"+recID).append("','")
	                 .append(Contextpath).append("')\"").append(tab)
		   ...
		   if (type==2||type==3){
			   sb.append("<g onmouseover=\"byRecSelected('2',evt,'").append(recID)
			     .append("','").append(subprocinstid+"#"+htID).append("','")
			     .append(Contextpath).append("')\"").append(tab)
			     .append(" onmouseout=\"unOldRecSelected(evt,'").append("rec"+recID).append("','")
                 .append(Contextpath).append("')\"").append(tab);
			   sb.append("onclick=\"subproc_onClick(evt,'")
			     .append(recID).append("','").append(subprocinstid).append("')\"").append(tab);			     
			   sb.append(" id=\"").append(htID).append("\">").append(tab);
			   sb.append("<rect x=\"").append(x).append("\" y=\"").append(y)
			     .append("\" width=\"41\" height=\"41\" style=\"fill:")
			     .append(color).append(";fill-opacity: 0.6;\" ")
			     .append("id=\"").append("rec"+recID).append("\"/>")
		   ...
		   if (type==4){
			   ...
			   if(htID==recID)
				   curID ="none";
			   sb.append("<g onmouseover=\"byRecSelected('4',evt,'").append(recID)
			     .append("','").append(htID).append("','")
			     .append(Contextpath).append("')\"").append(tab)
			     .append(" onmouseout=\"unOldRecSelected(evt,'").append("rec"+recID).append("','")
                 .append(Contextpath).append("')\"").append(tab);
               sb.append("onclick=\"event_onClick(evt,'")
			     .append(curID).append("','").append(recID).append("')\"").append(tab)
			     .append(" id=\"").append(htID).append("\">").append(tab);	
			   sb.append("<rect x=\"").append(x).append("\" y=\"").append(y)
			     .append("\" width=\"41\" height=\"41\" style=\"fill:")
		   ...
		   if (type==5){
			   sb.append("<rect x=\"").append(x).append("\" y=\"").append(y)
			     .append("\" width=\"25\" height=\"25\" style=\"fill:#FFFFFF;\" ")
			     .append("id=\"").append("rec"+recID).append("\"/>")
			     .append(tab);
		   ...
		   if (type==7){
			   ...
			   if (curID.equals("none")){
				   ...
				   sb.append("<g onclick=\"parallel_onClick(evt,'")
				     .append(curID).append("')\"").append(tab)
				     .append(" id=\"").append(htID).append("\">").append(tab);					   
				   sb.append("<rect x=\"").append(x).append("\" y=\"").append(y)
				     .append("\" width=\"25\" height=\"25\" style=\"fill:#FFFFFF;\" ")
				     .append("id=\"").append("rec"+recID).append("\"/>")
		   ...
		   if (type==13){
			   String keyID = process.getCompenONodeID(actdef.getID());
			   if(comps.containsKey(keyID)){
				   String value = (String)comps.get(keyID);
				   String newValue = value+"#"+"0,"+(String)this.activitiesXY.get(actdef.getID());
				   comps.put(keyID,newValue);
			   }else{
				   String newValue = "0,"+(String)this.activitiesXY.get(actdef.getID());
				   comps.put(keyID,newValue); 
			   }
			   sb.append("<rect x=\"").append(x).append("\" y=\"").append(y)
			     .append("\" width=\"23\" height=\"23\" style=\"fill:#FFFFFF;\" ")
			     .append("id=\"").append("rec"+recID).append("\"/>")
			     .append(tab);
	...
	private String createActivitieName(Hashtable states,Hashtable actinst,
			Hashtable subproc,NWActDef actdef)throws NWException{
		   StringBuffer sb = new StringBuffer();
		   String actPosition = (String) this.activitiesXY.get(actdef.getID());
		   String pos[] = actPosition.split(",");
		   int x = Integer.valueOf(pos[0]).intValue();
		   ...
		   if (type==4){
			   for (int i=0;i<names.length;i++){
				   sb.append("<text x=\"").append(x+41/2).append("\" y=\"")
				     .append(y+51+i*11).append("\" style=\"text-anchor: middle\"")
				     .append(">").append(names[i]).append("</text>").append(tab);
			   }
