package com.neusoft.uniflow.web.standard.workitemmgt.overtimework.actions;
...
import com.neusoft.uniflow.web.standard.workitemmgt.overtimework.forms.OverTimeWorkListForm;
import com.neusoft.uniflow.web.util.WorkflowManager;

public class OverTimeWorkListAction extends OpenListAction {
	private static int WORKITEMTYPE = 4;
	public void handleRequest(String userID, ActionMapping mapping,
			ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		OverTimeWorkListForm handleForm = (OverTimeWorkListForm) form;
	...
	public Vector openList(String userID, NWSession nwsession,
		...
		if (list != null && list.size() > 0)
			handleForm.setSelectedItem(((com.neusoft.uniflow.api.handler.NWWorkItem) list.elementAt(0)).getWorkItemID());
