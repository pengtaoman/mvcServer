...
public class LargeButtonTag extends TagSupport {
	...
	public int doStartTag() throws JspTagException {
		...
		results.append("<td class=\"large_button_td\" >\n");
	...
	public int doEndTag() throws JspTagException {
		StringBuffer results = new StringBuffer();
		if (width != null) {
			results.append("\" class=\"button_large\" style=\"width:");
			results.append(this.width);
			results.append("px;");
		} else {
			results.append("\" class=\"button_large");
		}
		if(!action.equals("#")){
