...
import com.neusoft.uniflow.api.bizhandler.NWBizProcInst;
 ...
 */
public class BizProcContentTag extends NoContentBaseTag {
	private static final long serialVersionUID = 123472;

	private String name;

	private String category;

	public BizProcContentTag() {
	...
	protected String getOutput() {
		...
		for (int i = 0; i < names.length; i++) {
			if (!extendvalues.equals("")
				...
				String value = (String) (((NWBizProcInst) pageContext
