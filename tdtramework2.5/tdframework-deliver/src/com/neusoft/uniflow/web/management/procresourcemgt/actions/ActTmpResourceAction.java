...
import com.neusoft.uniflow.web.management.procresourcemgt.forms.ActTmpResourceForm;
import com.neusoft.uniflow.web.util.CustomHandler;
import com.neusoft.uniflow.web.util.SessionManager;
import com.neusoft.uniflow.web.util.UniException;
import com.neusoft.uniflow.web.util.WorkflowManager;

public class ActTmpResourceAction  extends Action {
	
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws NWException {
		
		ActTmpResourceForm openListForm = (ActTmpResourceForm) form;
		...
		int pagesCount;
		try {
			int itemsCount =resourceManager.getActTmpNumByClassifiedID(parentIdStore);
	...
	public Vector openList(String userID, NWProcDefManager resourceManager,
		...
		Vector list = resourceManager.openActTmpListByClassifiedID(param.getStart(),param.getOffset(), param.getOrderBy(),param.isIsAscending(),resource_id);
