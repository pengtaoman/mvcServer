...
import com.neusoft.uniflow.web.management.procresourcemgt.forms.VarTmpResourceForm;
...
public class VarTmpResourceAction  extends Action {
	
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) throws NWException {
		
		VarTmpResourceForm openListForm = (VarTmpResourceForm) form;
		...
		int pagesCount;
		try {
			int itemsCount =resourceManager.getVariableNumByClassifiedID(parentIdStore);
	...
	public Vector openList(String userID, NWProcDefManager resourceManager,
		...
		Vector list = resourceManager.openVariableListByClassifiedID(param.getStart(),param.getOffset(), param.getOrderBy(),param.isIsAscending(),resource_id);
