...
public class VarTmpManagerAction extends DispatchAction {
	private Log log = LogFactory.getLog(ActTmpManagerAction.class);

	public ActionForward variableManager(ActionMapping actionMapping,
			ActionForm actionForm, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		return actionMapping.findForward("variableManager");
	}
	...
	public ActionForward addCategory(ActionMapping actionMapping,
		...
		if (inserttype.equals("category")) {
			...
			newCategory.setType(ICategoryEntry.VARIABLE);
	...
	public ActionForward getCategory(ActionMapping actionMapping,
		...
		if ("root".equals(type)) {
			...
			List categories = (List) categoryEntry.openAbsoluteRootCategoryList(ICategoryEntry.VARIABLE);
