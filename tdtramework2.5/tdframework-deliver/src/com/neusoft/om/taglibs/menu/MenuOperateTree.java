 ...
 * 
 */
public class MenuOperateTree extends BaseXMLTagLib{
	...
	protected void init(HttpServletRequest request) {
		menuOperateColl = (MenuOperateColl)request.getAttribute(OMRequestParameter.MENU_TREE);		
	}
	...
	protected void createTagBody() throws IOException {
		...
		if(menuOperateColl==null) return;
		...
		if(loopPoint>=menuOperateColl.getRowCount()){
		break;
		}
		...
		function = menuOperateColl.getMenu(loopPoint);
