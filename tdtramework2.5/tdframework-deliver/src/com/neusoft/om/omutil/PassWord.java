...
public class PassWord
{
	...
	public static boolean includeChineseChar(String strPwd){
		int l=strPwd.length();   
		for (int i=0;i<l;i++){   
			if(strPwd.charAt(i)<0||strPwd.charAt(i)>255||strPwd.charAt(i)==38||strPwd.charAt(i)==35 ||strPwd.charAt(i)==36 ||strPwd.charAt(i)==37 ||strPwd.charAt(i)==63||strPwd.charAt(i)==64||strPwd.charAt(i)==42 ||strPwd.charAt(i)==94  )
				return true;   
		}   
		return false;   
	}
	...
	public static void main(String args[]) {
		//System.out.println(PassWord.encode("unitele"));
