...
<html>
    <head>
        ...
        <%@ include file="/unieap/ria3.3/pages/config.jsp" %>
         <script type="text/javascript" src="<%=appPath%>/pages/samples/server/pojo/pojo.js"></script>
	</head>
    <body class="unieap">
    	<div style="line-height:20px;font-size: 13px;font-family: 宋体" dojoType="unieap.layout.TitlePane" title="说明">
			用户交互层 + 业务逻辑层 + 持久层样例，其中持久层用POJO实现。<br/>
		</div>
		<div dojoType="unieap.layout.TitlePane" title="查询条件">
			<form id="queryForm" dojoType="unieap.form.Form">
			 <fieldset dojoType="unieap.form.FieldSet" title="查询条件">
				<table width="100%">
					<tr>
						<td><label for="empno"> 编号: </label></td>
						<td><div  id="empno"  dojoType="unieap.form.NumberTextBox" ></div></td>
						<td><label for="ename"> 姓名: </label></td>
						<td><div  id="ename"  dojoType="unieap.form.TextBox" /></div></td>
						<td><label for="deptno"> 部门: </label></td>
						<td><div  id="deptno" dojoType="unieap.form.ComboBox" readOnly="true" dataProvider="{store:'DEPT'}"></div></td>
					</tr>
				</table>
			 </fieldset>
						...
						<fieldset dojoType="unieap.form.FieldSet" title="信息录入">
							<table width="100%" style="table-layout:fixed" >
								...
								<tr style="height:40px">
									...
									<td><div id="empNo4Check"binding="{name:'empno'}" dojoType="unieap.form.NumberTextBox" width="100%" required=true></div></td>
								...
								<tr style="height:40px">
									...
									<td colspan="2"><div binding="{name:'ename'}" dojoType="unieap.form.TextBox" width="100%"></div></td>
								</tr>
								<tr style="height:40px">
									<td><label> 职位: </label></td>
									<td colspan="2"><div binding="{name:'job'}" dojoType="unieap.form.TextBox" width="100%"></div></td>
								</tr>
								<tr style="height:40px">
									<td><label> 工资: </label></td>
									<td colspan="2"><div binding="{name:'sal'}" dojoType="unieap.form.NumberTextBox"  width="100%" range="{allowDecimal:false}"
									></div></td>
								</tr>
								<tr style="height:40px">
									<td><label> 入职时间: </label></td>
									<td colspan="2"><div binding="{name:'hiredate'}" dojoType="unieap.form.DateTextBox" width="100%" displayFormatter="{dataFormat:'yyyy-MM-dd'}"></div></td>
								</tr>
								<tr style="height:40px">
									<td><label> 部门: </label></td>
									<td colspan="2"><div binding="{name:'deptno'}" readOnly="true" dojoType="unieap.form.ComboBox" width="100%" dataProvider="{store:'DEPT'}" required=true></div></td>
								</tr>
							</table>
						</fieldset>
					</form>
		  ...
		  <div id="leftContent" style="float:right;width:74%;">
			     <div dojoType="unieap.layout.TitlePane" title="人员信息" style="height:350px">
			       <div id="empGrid" dojoType="unieap.grid.Grid" width="auto" height="280px" 
						...
						<toolbar paging="{url:'/modelpojo.do?method=loadPojo',onPagingModified:onPM,onAfterPaging:onAfterPaging}"></toolar>
					</div>
					<div style="text-align:right">
