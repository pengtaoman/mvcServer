...
<html>
	...
	<script type="text/javascript" src="<%=appPath%>/pages/samples/model/model6/model16_dialog.js"></script>
	...
	<body class="unieap">
		...
		<div dojoType="unieap.layout.TitlePane" title="部门信息" >
			<div dojoType="unieap.grid.Grid" width="100%" id="grid" views="{rowBar:true}" selection="{selectType:'s'}">
				<header>
