...
<script type="text/javascript" src="<%=appPath%>/pages/samples/model/model8/model8_query_dialog.js"></script>
...
<body class="unieap">
	<div dojoType="unieap.layout.TitlePane" title="查询条件" flexible="false" style="width:auto">
			...
			<div dojoType="unieap.form.FieldSet" title="查询条件">
				<table>
					<tr>
						...
						<td width="150px">
							<div dojoType="unieap.form.NumberTextBox" id="deptno_box" width="120px">
							</div>
						</td>
						<td>
							<label>部门名称:</label>
	...
	<div dojoType="unieap.layout.TitlePane" title="部门信息" flexible="false" style="width:auto">
