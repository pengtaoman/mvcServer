...
<html>
	...
	<script type="text/javascript" src="<%=appPath%>/pages/samples/model/model7/model7.js"></script>
	<script type="text/javascript">
		
	</script>
	<body class="unieap">
		<div style="line-height:20px;font-size: 13px;font-family: 宋体" dojoType="unieap.layout.TitlePane" title="说明">
			通过一个dialog查询数据对多个容器内的控件进行绑定。<br>
		</div>
		...
		<div dojoType="unieap.layout.TitlePane" title="资产信息">
