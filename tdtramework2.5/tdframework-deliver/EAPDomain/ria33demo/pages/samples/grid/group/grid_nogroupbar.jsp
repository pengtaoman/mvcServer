...
<html>
    ...
    <body class="unieap">
    	<div style="line-height:20px;font-size: 13px;font-family: 宋体;color:red;" dojoType="unieap.layout.TitlePane" title="说明">
			在group内配置groupBar为false。
		</div>
		<div id="grid" dojoType="unieap.grid.Grid" width="100%" height="200px"
			binding="{store:'empDataStore'}"
			group="{name:['attr_deptno'],groupBar:false}">
			<fixed>
