...
Form.Element.Serializers = {
  ...
  inputSelector: function(element) {
      return element.checked?[element.name, element.value]:null;
  },
...
var ElementUtil={
	showhideCore : function(att,attarg,elems){
				...
				for (var i = 0; i < elems.length; i++) {
				  var element = $(elems[i]);
				  ElementUtil.style[att] = attarg;
				}
		},
	hide: function() {
				var att='display' ,attarg='none';
				ElementUtil.showhideCore(att,attarg,arguments);
		  },
	hideb: function() {
	...
	toggle: function() {
				...
				for (var i = 0; i < arguments.length; i++) {
				  var element = $(arguments[i]);
				  attarg=ElementUtil.visible(element) ? 'none' : '';
				  ElementUtil.showhideCore(att,attarg,element);
				}
		},
	toggleb: function() {
				var att='visibility' ,attarg='';
				for (var i = 0; i < arguments.length; i++) {
				  var element = $(arguments[i]);
				  attarg=ElementUtil.visibleb(element) ? 'hidden' : '';
				  ElementUtil.showhideCore(att,attarg,element);
				}
		},
