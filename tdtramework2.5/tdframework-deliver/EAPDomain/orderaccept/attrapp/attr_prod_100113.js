BusCard.define('/orderaccept/attrapp/attr_prod_100113',function(_buscard,cardParam){
				...
				dojo.subscribe("/buscard/baseStation/propertychange",function(event){
			        ...
			        if(uniqueId == targetUniqueId){
						...
						if(!!baseStationList&&baseStationList.length>0){
							//赋值给基站编号和交换局编号
							if(Me.$('100113')){
								Me.$('100113').value = baseStationId;
							}
							if(Me.$('100096')){
								Me.$('100096').value = baseStationList[0].switchId;
							}
						}
			        }
				});
