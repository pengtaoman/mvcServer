BusCard.define('/orderaccept/attrapp/attr_prod_300081.js', function(_buscard, cardParam) {
	...
	Me.$("300081").onblur=function(){
		Me.checkTelephone(Me.$("300081"));
	}
	
	Me.$("300081").onkeypress = function(){
