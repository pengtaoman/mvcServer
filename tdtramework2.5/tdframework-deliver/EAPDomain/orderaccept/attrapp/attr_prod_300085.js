BusCard.define('/orderaccept/attrapp/attr_prod_300085.js', function(_buscard, cardParam) {
	...
	Me.$("300085").onblur=function(){
		Me.checkTelephone(Me.$("300085"));
	}
	
	Me.$("300085").onkeypress = function(){
