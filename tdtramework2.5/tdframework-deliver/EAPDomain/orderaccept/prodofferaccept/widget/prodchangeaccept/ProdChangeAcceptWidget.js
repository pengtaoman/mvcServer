defineModule("orderaccept.prodofferaccept.widget.prodchangeaccept.ProdChangeAcceptWidget", [
                "../mainprodoffer/MainProdOfferFlatWidget", "../../util"], function(
                MainProdOfferFlatWidget, util) {
	        var mm = "orderaccept.prodofferaccept.widget.prodchangeaccept.ProdChangeAcceptWidget";
	        /**
	        ...
	        dojo.declare(mm, [MainProdOfferFlatWidget], {
		        ...
		        templatePath : dojo.moduleUrl(
		                "orderaccept.prodofferaccept.widget.prodchangeaccept",
		                "template/prodChangeAcceptTpl.html"),
