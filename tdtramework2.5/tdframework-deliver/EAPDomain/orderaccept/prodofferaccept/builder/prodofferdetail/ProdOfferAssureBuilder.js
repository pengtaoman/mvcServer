defineModule(
		"orderaccept.prodofferaccept.builder.prodofferdetail.ProdOfferAssureBuilder",
		["../../util", "../../widget/assurecard/AssureCardWidget",
			 ...
			 * 定义销售品担保类
			 */
			dojo.declare("orderaccept.prodofferaccept.builder.prodofferdetail.ProdOfferAssureBuilder",[],{
		        ...
		        initProdOfferAssure : function(){
		        	var builder = this,
                        ...
                        uniqueId = !!builder.detailBuild && !!builder.detailBuild.provider?builder.detailBuild.provider.uniqueId:"",
		        	...
		        	var assureView = builder.initAssureView(subRowIndex,uniqueId);
			        ...
			        dojo.forEach(prodOfferAssureInfoList,function(assureInfo){
			        	...
			        	switch(assureInfo.securityMethodCD){
			        		...
			        		case builder.AssureMethodConst.ASSURE_PROMOTION : assureName = "租机担保";break;
			        ...
			        var grid = new BusCardGrid({
			        		cm:cm,
			        		ds:ds
			        	},dojo.query(".assureInfo"+subRowIndex+"-"+uniqueId,contentPane.domNode)[0]);
		         ...
		         * 初始化页面布局
		         */
		        initAssureView : function(rowIndex,uniqueId){
		        	return "<div id='assureAttr"+rowIndex+"\' class='assureAttr"+rowIndex+"\'></div>"+
		        		   "<div id='assureInfo"+rowIndex+"-"+uniqueId+"\' class='assureInfo"+rowIndex+"-"+uniqueId+"\'></div>"+
