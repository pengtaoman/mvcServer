...
<%
	...
	paramStr.append("STAFFNO=").append(userName).append("&PASSWORD=").append(endpassword);
	//获取数据信息
...
<link rel="stylesheet" href="<%=path%>/tdframework/mainframe/css/td_style_left_dx.css" type="text/css"/>
...
<script type="text/javascript" src="<%=path%>/tdframework/mainframe/js/menutree.js" ></script>
<script type="text/javascript" src="<%=path%>/tdframework/mainframe/js/left.js" ></script>
...
function dealLeaf(obj){
	...
	if(mtd=="0"){
		...
		if(typeof(eStatus)=="undefined"){
			...
			var toExpireWarnMsg = "许可证即将过期，请联系管理人员！项目信息：项目编号：" + menuObj.projectNo + ";项目名称：" + menuObj.projectName+";许可证到期日："+menuObj.expiredDate+";许可证编号："+menuObj.licenseNo;
...
<form name="myform">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%" bgcolor="#f6f6f6" >
		  <tr> 
			...
			<div id="menuBox" style="overflow-x:auto;overflow-y:auto;width:155px;height:100%;display:block;">
