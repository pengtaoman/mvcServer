...
var MenuBar=new function(){
	...
	Me.overMenu=function(){
		...
		mobj.style.setAttribute("filter","progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr='#f15a22', EndColorStr='#f15a22')");
		if ($("sub_"+mobj.id)){
	...
	Me.selectMenu=function(){
		...
		*/
		if (Me.lockMenu!=null){
			...
			Me.lockMenu.style.color="#838383";
		...
		Me.lockMenu.style.backgroundColor="#f15a22";
		Me.lockMenu.style.color="#ffffff";
		if ($("sub_"+mobj.id)){
			$("sub_"+mobj.id).style.display="block";
		}else{
			//currentTopMenu=null;
