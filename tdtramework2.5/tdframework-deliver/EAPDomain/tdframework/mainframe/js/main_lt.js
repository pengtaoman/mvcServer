...
function queryFavorite(){
	...
	if (isContinue){
		...
		parent.frames["main"].location.href = webpath+"/favoriteMenuAdmin.do?operType=query";

		parent.work_items.setNav(  ["收藏夹管理"] );
		

		/*
		var formf =	document.getElementById("favorite");
		formf.operType.value="query";
...
function addToFavorite(){
		...
		if (isContinue){
			...
			alert(" favoriteName is " + favoriteName);
