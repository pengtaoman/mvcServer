...
<head>
	...
	<script  language=javascript src="/tdframework/unieap/js/Globals.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/Common.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/Tree.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/BaseObj.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/EAPObjsMgr.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/NumberObj.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/DoubleObj.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/IDCardObj.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/IntegerObj.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/MoneyObj.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/PasswordConfirmObj.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/PasswordObj.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/PosIntegerObj.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/ReadOnlyFieldObj.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/ReadOnlyObj.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/TextObj.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/TextAreaObj.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/SelectObj.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/QuickSelectObj.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/FormatNumber.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/CursorDispose.js"> </script>
	<script  language=javascript src="/tdframework/unieap/js/EmailObj.js"> </script>
	<script type="text/javascript" src="<%=webpath%>/unieap/js/DWNameRule.js"></script>
	...
	<script language="javascript" src="<%=webpath%>/tdframework/demo/js/tab1.js"></script>
...
<table bordercolordark="#FFFFFF" bordercolorlight="#E8E8E8" cellspacing="0"  class="main_table3_4" border="0" width="95%" align="left">
    <tr> 
      <td class="main_table3_2_th" valign="middle" > <span class="text_title">查询条件界面</span></td>
    </tr>
    <tr> 
      <td class="main_table3_3_td" valign="middle"  width="80"> 
        <table cellspacing="0" class="main_table5">
          ...
          <tr> 
            ...
            <td class="main_table5_td1" valign="middle" > 
               <unieap:input tcname="PasswordConfirm" id="confirmpassword" name="confirmpassword" prompt="确认密码" isnullable="true" prePassword="password" />*
            </td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td class="main_table5_td1" valign="middle" > 
               <unieap:input tcname="QuickSelect" id="certificateType" name="certificateType" prompt="区域" isnullable="true" style="width:150" onchange="">
          ...
          <tr> 
            ...
            <td class="main_table5_td1" valign="middle"  colspan="3" > 
               <unieap:input securityid="" tcname="TextArea" id="remark" name="remark" prompt="备注" rows="3" cols="53" isnullable="true" value="<%=remark%>" onkeydown=" foucsto()"/>
            </td>
          </tr>
          <tr>
