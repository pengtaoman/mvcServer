...
<%
	...
	ParamObjectCollection operTypeColl= (ParamObjectCollection)request.getAttribute("operTypeColl");
...
<script type="text/javascript">
		...
		function bQueryClick(){	
			...
			document.forms[0].target='PowerLogList';
			document.forms[0].action='powerLogAction.do?method=getPowerLogInfo';
		 ...
		 <tr class="tableTitleTR2">
			<td colspan="4" >
				<table width="100%" border="0" cellpadding="0" cellspacing="0" >
					...
					<td class="tableTitle2" id="qd_mgr">赋权日志查询</td>
					</tr>
				 </table>
			 </td>
		</tr>
	       ...
	       <td class="formTableC">		 	 			
			<table border="0" cellpadding="0" cellspacing="2" class="formTableCore">
				<tr>		
					...
					<td class="formLabel" width="13%" align="left">操作类型</td>
					<td class="formField" align="left">
						<td:SelectTag selectColl="<%=operTypeColl%>" selectFlag="" selectvalue=""  tagName="operType" title="操作类型" />
					</td>          
				  </tr>
				  <tr>
				  ...
				  <tr>		
					<td class="formLabel" width="13%"align="left">操作人工号</td>
					<td class="formField" align="left">
						<input type="text" name="workNo" id="workNo" value="" />
					</td>  					
					<td class="formLabel" width="13%" align="left">被操作对象工号</td>
					<td class="formField" align="left">
						<input type="text" name="operObj" id="operObj" value="" />						
					</td>          
				  </tr>	
			</table>
		   </td>
