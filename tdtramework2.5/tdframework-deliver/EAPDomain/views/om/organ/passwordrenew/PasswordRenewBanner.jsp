...
<script language="JavaScript">
	function bSubmitClick(){
		...
		parent.bottom.location.href = myform.Path.value+"/om/PasswordRenewAction.do?OperType=query&WorkNo="+myform.WorkNo.value;
		return;
	}
	function bResetPwdClick(){
		parent.bottom.location.href = myform.Path.value+"/om/PasswordRenewAction.do?OperType=renew&WorkNo="+parent.bottom.myform.WorkNo.value;
	}
	function init(){
		var arrayBtn=new Array(myform.bSubmit,myform.bResetPwd);
...
<TABLE border="0" align="center" cellpadding="0" cellspacing="1">
 ...
 onmouseout="this.className='btn3_mouseout'" onmousedown="this.className='btn3_mousedown'"  onmouseup="this.className='btn3_mouseup'">
			...
			<input type="button" value="密码恢复" onClick="bResetPwdClick();return false;" name="bResetPwd" disabled="true" class="btn3_mouseout" nmouseover="this.className='btn3_mouseover'"
 onmouseout="this.className='btn3_mouseout'" onmousedown="this.className='btn3_mousedown'"  onmouseup="this.className='btn3_mouseup'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</TD>
	</TR>
</form>
