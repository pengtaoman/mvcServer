...
<html>
	...
	<script language="javascript" src="{root/create/path}/views/om/organ/employee/OrganDisplay.js"></script> 			  			  
...
<xsl:template match="root/create">
	...
	<input type="hidden" name="adminType"  value="{adminType}"></input>
	<input type="hidden" name="ulp"  value="{ulp}"></input>
