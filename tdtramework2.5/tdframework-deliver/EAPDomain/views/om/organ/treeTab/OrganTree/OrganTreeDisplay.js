  ...
  if (myform.alertMessage.value.length>0)
   ...
   function checkradio(obj){
        ...
        if(obj.kind =="area"){
            ...
            parent.employeemaintance.location.href = webpath+"/views/om/blank.html"//"EmployeeQueryAction.do?"+"&OrganKind='area'"+"&BelongArea="+obj.belongArea+"&AreaId= " + obj.value + "&OperType=employeeList";
            parent.employeelist.showWaitingBar();
            parent.employeelist.location.href = webpath+"/om/EmployeeQueryAction.do?OrganKind='area'&BelongArea="+obj.belongArea+"&AreaId=" + obj.value + "&OperType=employeeList";
            parent.employeebutton.myform.bAdd.disabled = true;
   ...
   function checkradio(obj){
	    var sArea = obj.belongArea;
 	    var sId = obj.id;
	    var id = sId.substring(1);	    
	 	var areaObj = parent.parent.parent.parent.logquerybanner.document.forms[0].area;	
	 	if(areaObj != null){
	 		areaObj.value = sArea;
	 	}
	 	var path= document.getElementById("path").value;
		parent.dealerTree.location.href = path+"/om/LogQueryAction.do?OperType=showDealerTree&OrganId="+id;
	 }