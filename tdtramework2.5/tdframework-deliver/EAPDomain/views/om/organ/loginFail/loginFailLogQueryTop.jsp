...
<%@ page import="com.neusoft.tdframework.common.util.DateUtil"%>
...
<html>
	<head>
		...
		<script language="javascript"
			src="<%=path%>/views/common/js/nas_check_no_null.js"></script>
		<script language="javascript"
			src="<%=path%>/views/common/js/nas_date_compare.js"></script>
...
function bQueryClick(){	
	...
	document.forms[0].action='<%=path%>/loginFailLogQueryAction.do?method=query';
	...
	<body onload="load('<%=beginDate%>','<%=endDate%>');">
		<unieap:form method="post" action="">
				...
				<tr>
					...
					<td class="formTableC">
						<table border="0" cellpadding="0" cellspacing="2"
							class="formTableCore">
							<tr>
								<td class="formLabel" width="13%" align="left">
									员&#160;&#160;工&#160;&#160;号
									<span class="formRequested"></span>
								</td>
								<td align="left" class="formField">
									<input type="text" id="loginId" name="loginId" class="textType" />
								</td>
							</tr>
							<tr>
								<td class="formLabel" width="16%" align="left">
									起始时间&#160;&#160;
									<span class="formRequested">*</span>
								</td>
								<td class="formField" align="left">
									<input type="text" maxlength="16" class="dateField"
			...
			<div class="formButtonDIV" id="filebutton" style="display: block">
				<button class="formButton" name="bQuery" onclick="bQueryClick()">
					查&#160;&#160;询
				</button>
			</div>
		</unieap:form>
