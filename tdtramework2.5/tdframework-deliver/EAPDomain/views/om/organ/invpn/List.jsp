...
<body onload="init()">
	<ec:table items="ipsInvpnList" var="ipsInvpn" rowsDisplayed="10" action="${pageContext.request.contextPath}/ipsInvpnAction.do?method=query"> 
			<ec:row>
				...
				<ec:column property="ipSegmentId" title="网段标识" style="text-align:left" />
				<ec:column property="ipSegmentAddress" title="网段地址" style="text-align:left" />
				<ec:column property="ipSegmentDesc" title="说明" style="text-align:left"/>
		   </ec:row>		
	</ec:table>
