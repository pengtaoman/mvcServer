  ...
  if (myform.alertMessage.value.length>0)
   ...
   function checkradio(obj){
       //parent.mainFrameset.cols="35%,*,0,0,0";
        ...
        if(obj.kind =="area"){
            //将当前选中的结点信息写入隐藏帧，为了使以后再actionBtn.jsp当中添加和删除员工与职务联系的时候提供数据。
            ...
            parent.actionbtn.document.all.message.innerText='您只能在职务上添加操作员';
            ...
            parent.actionbtn.document.all.message.innerText='您可以在此结点上添加操作员';
