...
<script language="javascript">
	...
	function doModify(path){
		...
		var url=path+"/om/empIpLimitAction.do?method=modiInit&workNo="+workNo+"&ipStartAdd="+priStartAdd+"&ipEndAdd="+priEndAdd+"&oper=modify";
	...
	function doDelete(path){	
		...
		document.EAPForm.action=path+"/om/empIpLimitAction.do?method=doDelete&workNo="+workNo+"&ipStartAdd="+ipStartAdd+"&ipEndAdd="+ipEndAdd;
		document.EAPForm.target='list';
		document.EAPForm.submit();
	}
	function doAdd(path){
		var url=path+"/om/empIpLimitAction.do?method=modiInit&oper=add";
...
<unieap:form  action="" method="post">
	...
	<input type="hidden" id="workNo" value=""/>
