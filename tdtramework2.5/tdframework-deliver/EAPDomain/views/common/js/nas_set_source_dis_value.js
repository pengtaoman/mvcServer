...
function nas_set_source_dis_value(select_info,is_ok)
{
	if (is_ok == "ok")
	{
		...
		if (the_info[1]!="")
		{
			...
			//{	
				...
				if (typeof(window.parent.frames['header'].document.forms[0].New_service_id)!='undefined')
					window.parent.frames['header'].document.forms[0].New_service_id.disabled = false;
				if (typeof(window.parent.frames['header'].document.forms[0].Service_id_toll)!='undefined')
					window.parent.frames['header'].document.forms[0].Service_id_toll.disabled = false;
				if (typeof(window.parent.frames['header'].document.forms[0].Service_id_pbx)!='undefined')
					window.parent.frames['header'].document.forms[0].Service_id_pbx.disabled = false;
			//}
			if (typeof(window.parent.frames['header'].document.forms[0].Service_id_temp)!='undefined')
				window.parent.frames['header'].document.forms[0].Service_id_temp.value = the_info[1];
			if (typeof(window.parent.frames['header'].document.forms[0].New_service_id)!='undefined')
				window.parent.frames['header'].document.forms[0].New_service_id.value = the_info[1];
			if (typeof(window.parent.frames['header'].document.forms[0].Service_id_toll)!='undefined')
				window.parent.frames['header'].document.forms[0].Service_id_toll.value = the_info[1];
			if (typeof(window.parent.frames['header'].document.forms[0].Service_id_pbx)!='undefined')
				window.parent.frames['header'].document.forms[0].Service_id_pbx.value = the_info[1];
			
			if (the_info[3]!="")
			{
				if (typeof(window.parent.frames['header'].document.forms[0].Area_id)!='undefined'){
					window.parent.frames['header'].document.forms[0].Area_id.value = the_info[3];
