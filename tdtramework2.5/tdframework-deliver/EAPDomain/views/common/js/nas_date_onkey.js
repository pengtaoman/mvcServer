...
/**
 * <p>Name: nas_date_onkey.js</p>
 * <p>Description: 预算、提交、查询密码、查询提交函数</p>
 * <p>AppArea: 营业系统二次受理业务公用</p>
...
function nas_date_onkey(event,this_field,marker,err_method)
{
	...
	{  	
		...
		for (i;i<this_field.form.elements.length;i++)
		{
			...
			{
				//alert(this_field.form.elements[i].name);
...
function nas_date_onkey_comm(event,this_field,marker,err_method,next_field)
{
    var scode = event.keyCode;//获得键盘至值。    
