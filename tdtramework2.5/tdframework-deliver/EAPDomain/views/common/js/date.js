...
var g_eC=null;var g_eCV="";var g_dFmt="yymmdd";var g_fnCB=null;
...
function SetDate(d,m,y){
  ...
  else if(g_dFmt=="yymmdd") g_eC.value=y+ds+m+ds+d;
  else g_eC.value=s+ds+m+ds+y;
  g_eCV=g_eC.value;
...
function LoadMonths(n,webpath){
  ...
  for(i=0;i<n;i++){
    ...
    rg[i].src=webpath+"/views/common/images/w"+GetDOW2(1,m,y)+"d"+GetMonthCount(m,y)+".gif";
	m++;
	if(12<m){ m=1;y++;}
  }
}

//LoadMonths(12,webpath);
