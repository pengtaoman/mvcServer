BusCard.define('/buscardapp/rela/js/card_129_10107.js',function(_buscard,cardParam){ 
var Me = this;
var a = arguments[0];
var b = arguments[1];
...
Me.refreshCityCode = function(){
	...
	if(result){
		...
		if(cityCodeList){
			Me.resetSelect(Me.$("cityCode"), cityCodeList, Me.cityCode);
		}
	}
	Me.$("cityCode").onchange = function(){
		Me.cityCode = Me.$("cityCode").value;
		Me.refreshBelongCode(Me.$("cityCode").value);
	}
	Me.$("cityCode").onchange();
}
Me.refreshBelongCode = function(cityCode){
	...
	Me.$("belongCode").onchange = function(){
		...
		Me.refreshBureauId(Me.$("belongCode").value, Me.$("cityCode").value);
	}
...
Me.refreshBureauId = function(belongCode, cityCode){
	...
	if(!Me.$("bureauId").onchange){
		Me.$("bureauId").onchange = function(){
			Me.refreshBranchNo(Me.$("branchNo").value, Me.$("cityCode").value);
		}
	}
...
Me.getStandardAddr = function () {
	...
	var F = C + "resource/interfacemanage/standardadd/StandardAddrQuery.jsp?STAFFNO=" + D + "&PASSWORD=" + A + "&workNo=" + D + "&regionno=" + E + "&cityCode=" + Me.$("cityCode").value + "&areaCode=" + Me.$("belongCode").value;
