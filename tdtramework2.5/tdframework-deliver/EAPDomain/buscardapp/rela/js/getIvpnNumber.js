BusCard.define('/buscardapp/rela/js/getIvpnNumber.js',function(_buscard,cardParam){ 
	var Me = this;
	var a = arguments[0];
	var b= arguments[1];
	//for compatibility
	...
	Me.getChooseNumber = function () {
		...
		var resultJsonStr = executeRequest("prodOfferSaleAjaxAction", "getBizId", parameter);
		var result = "-1";
		try {
