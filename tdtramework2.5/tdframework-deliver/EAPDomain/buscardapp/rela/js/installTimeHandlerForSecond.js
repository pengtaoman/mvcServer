BusCard.define('/buscardapp/rela/js/installTimeHandlerForSecond.js', function(_buscard, cardParam) {
	var Me = this;
	var a = arguments[0];
	var b = arguments[1];
    var c=b.serviceRelation.customerId;
    ...
    var customerData=BusCard.$remote("custBO").queryById({"custId":c});	
    var param = "&ServiceKind="+b.serviceRelation.serviceKind+"&apply_event="+b.serviceOfferId+"&infoId=1002";
