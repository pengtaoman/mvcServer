BusCard.define('/buscardapp/rela/js/card_171_10139.js',function(_buscard,cardParam){ 
Me = this;
...
Me.$("cardNo").onblur = function(){
	...
	if(!cardNoOnblur(cardNo,cardRecordId)){
		Me.$("cardNo").value == "";
		Me.$("cardNo").focus();
		return false;
	}
...
var cardInit = function(){
	...
	Me.setObjDisabled("backCardPrice");
	...
	if(cardInfo.cardNo && cardInfo.cardRecordId){
		Me.$("preCardNo").value = cardInfo.cardNo;
