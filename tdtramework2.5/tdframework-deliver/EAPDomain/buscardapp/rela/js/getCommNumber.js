BusCard.define('/buscardapp/rela/js/getCommNumber.js',function(_buscard,cardParam){ 
	var Me = this;
	var a = arguments[0];
	var b= arguments[1];
	//for compatibility
	...
	Me.belongCode = b.belongCode||b.serviceRelation.belongCode;
	Me.getChooseNumber = function () {
		var parameter = "cityCode=" + Me.cityCode+"&belongCode="+Me.belongCode;
		var resultJsonStr = executeRequest("prodOfferSaleAjaxAction", "getCommNumber", parameter);
		var result = "-1";
		try {
