BusCard.define('/buscardapp/rela/js/card_132_10132.js',function(_buscard,cardParam){ 
	Me = this;
	var a = arguments[0];
	var b = arguments[1];
	...
	if(Me.$("userName")){
    	var custIdentVO=BusCard.$remote("custIdentBO") .getCustIdentInfoByID({
						                                cityCode : b.serviceRelation.cityCode,
						                                custId: b.serviceRelation.subscriberId
					                                });
	    Me.$("userName").value=custIdentVO.custName;
	}
	if(Me.$("addrDetail")){
