		...
		<script type="text/javascript">
			...
			function query(){
				...
				var ddc=unieap.Action.requestData({
						url:unieap.WEB_APP_NAME + "/loadAppProcess.do?method=loadRunningAppProcess&type=2",
						sync:true,
						load:function(dc,ds){
						}
					},dc);
            ...
            function showDetail(){
            	...
            	if(index.length > 0){
	            	...
	            	var url = unieap.WEB_APP_NAME + "/runningAppProcessDetail.do?&type=2&procInstID=" + selectedProcID;
	            	window.open(url);
            	}
            }
    ...
    <body class="unieap" style="visibility:hidden;">
		<div id="grid" jsId="grid" dojoType="unieap.grid.Grid" width="100%" height="500px"
					...
					<header>
					 ...
					 <toolbar paging="{parameters:{'method':'loadRunningAppProcess','type':'2'},url:'/loadAppProcess.do'}">
