...
<!-- ============== applicationManager Start ============== -->
 	...
 	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/unieap/pages/workflow/stylesheet/applicationresourcemgt/applicationManager.css" />
	<%@include file="ext-js.jsp" %> 
    <script type="text/javascript" src="<%=request.getContextPath()%>/unieap/pages/workflow/js/AppResource-JS/appManager.js"></script>	
