...
<uniflow:p_body onload="javascript:onload()" width="90%">
	...
	<uniflow:m_form action="weekday.do">
		...
		<uniflow:tab width="85%">
			...
			<uniflow:tabElement messageKey="workflow.schedule.weekday"
				selected="true" action="javascript:button_onclick('weekday')" />
			<td></td>
		</uniflow:tab>
		<uniflow:p_content_wrapper>
			...
			<uniflow:p_content_table>
				...
				<uniflow:p_content_tr>
					<td class="main_label_td" valign="middle" nowrap>
						<bean:message bundle="uniflow"
							key="workflow.schedule.weekday.style.label" />
						&nbsp;
					</td>
					<td class="main_label_td" valign="middle" nowrap colspan="2">
						<html:select property="selDate" styleClass="input_text150">
							<html:options collection="allWeek" property="value"
								labelProperty="label" />
						</html:select>
					</td>
					<td>
