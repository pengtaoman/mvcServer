...
<uniflow:m_form action="editSchedule.do">
 <uniflow:tab >
    <uniflow:tabElement messageKey="workflow.schedule.weekday" selected="true" action="javascript:button_onclick('weekday')"/>
...
<uniflow:p_content_tr>
	<td class="main_label_td" valign="middle" nowrap><bean:message bundle="uniflow" key="workflow.schedule.weekday.style.label"/>&nbsp;</td>
	<td class="main_label_td" valign="middle" nowrap>
    <html:select property="selDate" styleClass="input_text150">
	  <html:options collection="allWeek"  property="value" labelProperty="label"/>
	  </html:select>
	</td>
    </uniflow:p_content_tr><!--
 <uniflow:p_content_tr>
...
<uniflow:p_action>
  <uniflow:button id="ok" action="javascript:button_onclick('WEEKOK')" name="button.ok"></uniflow:button>
