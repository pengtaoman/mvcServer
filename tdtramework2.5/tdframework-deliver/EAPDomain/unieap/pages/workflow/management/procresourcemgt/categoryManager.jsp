...
<!-- ============== categoryManager Start ============== -->
 	...
 	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/unieap/pages/workflow/stylesheet/procresourcemgt/categoryManager.css" />
	<%@include file="ext-js.jsp" %> 
    <script type="text/javascript" src="<%=request.getContextPath()%>/unieap/pages/workflow/js/CategoryResource-JS/categoryManager.js"></script>	
...
<tr>
	<td style="height:27px;background-color:#D6E2F2">
	<div id="main-tb"></div>
    </td>
</tr>
<tr>
	<td>
	<div id="tree" style="width:180px;height:450px;overflow:auto;border: 1px solid #99BBE8;"></div>
    </td>
</tr>
<tr>
</tr>
