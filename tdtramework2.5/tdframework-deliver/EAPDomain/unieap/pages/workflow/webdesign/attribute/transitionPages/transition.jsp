...
function addCondition(num){
    ...
    if(document.all){
       ...
       var action = '<%=closeflag%>';
          ...
          if (getTypeValue() == 1)
         	 document.transitionForm.priority.disabled = true;
    }
    </script>
    <script>
...
<div class="main_label_outline" style="width:570px">
		  	<table style="width:550px" class="main_label_table">
				<tr>
					<td align="left" style="width:89px"><bean:message bundle="uniflow" key="workflow.webdesign.name"/></td>
					<td>
					<html:text property="name" style="width:398px;" styleClass="input_underline"  value='<%=name%>'>
					</html:text>*
					</td>
				</tr>
				<tr>
					<td valign="top"  style="width:89px"><bean:message bundle="uniflow" key="workflow.webdesign.describe"/></td>
					<td><html:textarea property="desc" style="width:398px;" rows="5"  value='<%=((TransitionForm)request.getAttribute("TransitionForm")).getDesc()%>'/></td>
				</tr>
			</table>
			<table style="width:550px" class="main_label_table">	
				<tr>
					<td align="left" style="width:80px">类型:</td>
					<td align="left">
				...
				<tr>
					<td align="left" style="width:80px">优先级:</td>
					<td align="left">
						<html:text property="priority" style="width:398px;"  disabled="false"  styleClass="input_text"  value='<%=((TransitionForm)request.getAttribute("TransitionForm")).getPriority()%>'>
						</html:text>
					</td>
				</tr>
				<tr>
					<td align="left" valign="top" style="width:80px">条件表达式:</td>
				...
				<tr>
					...
					<td>
						  <html:textarea property="expression" style="width:398px;" rows="5" value='<%=((TransitionForm)request.getAttribute("TransitionForm")).getExpression()%>' />
					</td>
					<td valign="bottom"></td>
				</tr>
				</table>
