...
<html>
	...
	<body onload="initEvents()">
		...
		<br>
		<div class="main_label_outline" style="width:562">
			<table width="100%">
				<tr>
					<td style="font-size: 13px; width: 110px; height: 20px">
						事件程序处理器：
					</td>
					...
					<tr>
						<td style="font-size: 13px; width: 80px">
							...
							<input type="checkbox" id="procSuspendEvent" name="events"
								onclick="ock_check('procSuspendEvent')" value="">
							挂起
						</td>
						<td>
						...
						<td style="font-size: 13px; width: 80px">
							...
							<input type="checkbox" id="procCompletedEvent" name="events"
								onclick="ock_check('procCompletedEvent')" value="">
							完成
						</td>
						<td>
					...
					<tr>
						<td style="font-size: 13px; width: 80px">
							...
							<input type="checkbox" id="procAbortEvent" name="events"
								onclick="ock_check('procAbortEvent')" value="">
							终止
						</td>
						<td>
						...
						<td style="font-size: 13px; width: 80px">
							...
							<input type="checkbox" id="procStartEvent" name="events"
								onclick="ock_check('procStartEvent')" value="">
							启动
						</td>
						<td>
					...
					<tr>
						<td style="font-size: 13px; width: 80px">
							...
							<input type="checkbox" id="procRestartEvent" name="events"
								onclick="ock_check('procRestartEvent')" value="">
							重启动
						</td>
						<td>
						...
						<td style="font-size: 13px; width: 80px">
							...
							<input type="checkbox" id="procResumeEvent" name="events"
								onclick="ock_check('procResumeEvent')" value="">
							恢复
						</td>
						<td>
					...
					<tr>
						<td style="font-size: 13px; width: 80px">
							...
							<input type="checkbox" id="procCreateEvent" name="events"
								onclick="ock_check('procCreateEvent')" value="">
							创建
						</td>
						<td>
						...
						<td style="font-size: 13px; width: 80px">
							...
							<input type="checkbox" id="procDeleteEvent" name="events"
								onclick="ock_check('procDeleteEvent')" value="">
							删除
						</td>
						<td>
