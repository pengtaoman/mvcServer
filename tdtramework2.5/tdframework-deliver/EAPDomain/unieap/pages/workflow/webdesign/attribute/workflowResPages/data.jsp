	...
	<html:form action="toData.do">
		<div class="main_label_outline" style="width: 570px">
			<fieldset style="width: 460px;">
				...
				<table style="width: 560px" class="main_label_table">
					<tr>
					...
					<tr>
						...
						<td>
							<html:text property="name" style="width:400px;"
								...
								value='<%=((DataForm) request.getAttribute("DataForm"))
										.getName()%>'>
							</html:text>
						</td>
					</tr>
					<tr>
						...
						<td>
							<html:textarea property="desc" style="width:400px;height:50px"
								styleClass="input_text"
								value='<%=((DataForm) request.getAttribute("DataForm"))
									.getDesc()%>' />
						</td>
					...
					<table class="main_label_table">
						<tr>
							...
							<td width="60">
								<input type="radio" name="dateRadio" class="rodio"
									<%="1".equals(((DataForm) request
											.getAttribute("DataForm"))
											.getDataType()) ? "checked" : ""%>
									value="1" onclick="displayAdd()">
								字符串
								</input>
							</td>
							<td>
								<input type="radio" name="dateRadio" class="rodio" id="radioNum"
									<%="0".equals(((DataForm) request
											.getAttribute("DataForm"))
											.getDataType()) ? "checked" : ""%>
									value="0" onclick="displayCover()">
								数字
								</input>
							</td>
							<td>
								<input type="radio" name="dateRadio" class="rodio" id="radioXml"
									<%="10".equals(((DataForm) request
											.getAttribute("DataForm"))
											.getDataType()) ? "checked" : ""%>
									value="10" onclick="displayAdd()">
								XML
								</input>
							</td>
						</tr>
						<tr>
							...
							<td style="width: 50px">
								<input type="radio" name="mergeRadio" class="rodio"
									<%="1".equals(((DataForm) request
											.getAttribute("DataForm"))
											.getMergeRule()) ? "checked" : ""%>
									id="superadd" value="1">
								追加
								</input>
							</td>
					...
					<table style="width: 550px" class="main_label_table">
						<tr>
							...
							<td>
								<html:text property="defaultValue" style="width:400px;"
									styleClass="input_text"
									value='<%=((DataForm) request.getAttribute("DataForm"))
										.getDefaultValue()%>'>
								</html:text>
						...
						<tr>
							...
							<td>
								<html:text property="handleClass" style="width:400px;"
									styleClass="input_text"
									value='<%=((DataForm) request.getAttribute("DataForm"))
										.getHandleClass()%>'>
								</html:text>
				...
				<table style="" class="main_button">
					<tr>
						<td style="width: 560px" align="right">
				...
				<html:hidden property="mergeRule"
					value='<%=((DataForm) request.getAttribute("DataForm"))
									.getMergeRule()%>' />
