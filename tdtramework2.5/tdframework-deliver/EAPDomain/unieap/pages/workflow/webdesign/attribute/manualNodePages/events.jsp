...
<html>
	...
	<body onload="initEvents()">
		...
		<br>
		<div class="main_label_outline" style="width:563px">
			<table width="100%">
				<tr>
					<td style="font-size: 13px;width: 120px">
						事件程序处理器：
					</td>
					<td style="font-size: 13px; width: 420px; height: 20px">
						<input type="text" id="msgReceiver" onkeypress="validateInput()"
							value="" style="width:100%" maxlength="20">
					</td>
				</tr>
			</table>
					...
					<tr>
						<td style="font-size: 13px; width: 80px">
							...
							<input type="checkbox" id="actOpenEvent" name="events"
								onclick="ock_check('actOpenEvent')" value="">
							打开
						</td>
						<td>
						...
						<td style="font-size: 13px; width: 80px">
							...
							<input type="checkbox" id="actCloseEvent" name="events"
								onclick="ock_check('actCloseEvent')" value="">
							关闭
						</td>
						<td>
					...
					<tr>
						...
						<td style="font-size: 13px; width: 80px">
							...
							<input type="checkbox" id="actDeleteEvent" name="events"
								onclick="ock_check('actDeleteEvent')" value="">
							删除
						</td>
						<td>
					...
					<tr>
						...
						<td style="font-size: 13px; width: 80px">
							...
							<input type="checkbox" id="closeEvent" name="events"
								onclick="ock_check('closeEvent')" value="">
							关闭
						</td>
						<td>
					...
					<tr>
						...
						<td style="font-size: 13px; width: 80px">
							...
							<input type="checkbox" id="rollbackEvent" name="events"
								onclick="ock_check('rollbackEvent')" value="">
							回退
						</td>
						<td>
					...
					<tr>
						<td style="font-size: 13px; width: 80px">
							...
							<input type="checkbox" id="reassignEvent" name="events"
								onclick="ock_check('reassignEvent')" value="">
							重指派
						</td>
						<td>
					...
					<tr>
						<td style="font-size: 13px; width: 80px">
							...
							<input type="checkbox" id="createEvent" name="events"
								onclick="ock_check('createEvent')" value="">
							创建
						</td>
						<td>
						...
						<td style="font-size: 13px; width: 80px">
							...
							<input type="checkbox" id="deleteEvent" name="events"
								onclick="ock_check('deleteEvent')" value="">
							删除
						</td>
						<td>
					...
					<tr>
						<td style="font-size: 13px; width: 80px">
							...
							<input type="checkbox" id="commissionEvent" name="events"
								onclick="ock_check('commissionEvent')" value="test">
							代办
						</td>
						<td>
