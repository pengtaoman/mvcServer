...
<script type="text/javascript" src="<%=WorkflowManager.getWorkflowPath()%>/webdesign/js/expiration.js"></script>
	...
	<div id="application1" style="display:none">
		<table class="main_label_table">
			<tr>
				...
				<td><input type="text" id="delayApplication" class="input_text"  value='' style="width:250px"></input>&nbsp;<input type="button" class="button_small" value="浏览" name="openDelayApplication" onclick="openApp(event)">&nbsp;<input type="button" class="button_small" onclick="clearUp()" value="取消" >
				</td>
			</tr>
		</table>
	</div>
...
<fieldset style="width:500px;">
	...
	<div style="display:none"  id="alertVarSet">
		<table class="main_label_table">
			<tr>
				<td style="height:30px;width:90px" >变量设置:</td>
				<td><select NAME="Cats"  id="select2" class="input_text"  style="width:350px">
				 <option></option>
				 </select>
				</td>
			</tr>
	...
	<div id="application2" style="display:none">
		<table class="main_label_table">
			<tr>
				...
				<td>
				    <input type="text" id="alertApplication" class="input_text"  value=''  style="width:250px"></input>&nbsp;<input type="button" class="button_small" value="浏览"  name="openAlertApplication" onclick="openApp(event)">&nbsp;<input type="button" class="button_small" onclick="clearUp1()" value="取消" >
				</td>
			</tr>
		</table>
	</div>
