    ...
    onEditComplete : function(ed, value, startValue){
        ...
        if(String(value) !== String(startValue)){
            ...
            if(this.fireEvent("validateedit", e) !== false && !e.cancel){
            	if(field=="parentName"){
            		r.set("parentId", document.getElementById("editCell").value);
            	}else if(field=="subName"){
            		r.set("subId", document.getElementById("editCell").value);
            	}else{
            		r.set("mappId", document.getElementById("editCell").value);
            	}
                r.set(field, value);
                delete e.cancel;
