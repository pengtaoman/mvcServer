...
function setParentValue(){
	...
	window.opener.document.parallelForm.exActionName.value =sendExAn;//send Delay Time
	window.opener.document.parallelForm.exAlertActionName.value =sendExAAN;//send Delay Time
	window.opener.document.parallelForm.duration.value =sendDelayTime;//send Delay Time
	window.opener.document.parallelForm.alertDuration.value=sendAlertTime;//send Alert Time
	window.opener.document.parallelForm.alertActionInterval.value=sendIntervalTime;//send alarm Interval Time
	window.opener.document.parallelForm.varOrDur.value=sendDelayVar;//send delay radio variable choice
	window.opener.document.parallelForm.alertVarOrDur.value=sendAlertVar;//send alerm radio variable choice
	window.opener.document.parallelForm.actionType.value=sendDelayType;//send delay type
	window.opener.document.parallelForm.alertActionType.value=sendAlertType;//send alarm type
	window.opener.document.parallelForm.actionApplication.value=sendDA;//send Delay application program
	window.opener.document.parallelForm.alertActionApplication.value=sendAA;//send Alarm application program
	window.opener.document.parallelForm.variable.value=sendVariable;//send delay variable select choice
	window.opener.document.parallelForm.alertVariable.value=sendAlertVariable;//send alarm variable select choice
	window.opener = null;
	window.close();
}
