...
function setParentValue(){
	...
	window.opener.document.procForm.exActionName.value =sendExAn;//send Delay Time
	window.opener.document.procForm.exAlertActionName.value =sendExAAN;//send Delay Time
	window.opener.document.procForm.duration.value =sendDelayTime;//send Delay Time
	window.opener.document.procForm.alertDuration.value=sendAlertTime;//send Alert Time
	window.opener.document.procForm.alertActionInterval.value=sendIntervalTime;//send alarm Interval Time
	window.opener.document.procForm.varOrDur.value=sendDelayVar;//send delay radio variable choice
	window.opener.document.procForm.alertVarOrDur.value=sendAlertVar;//send alerm radio variable choice
	window.opener.document.procForm.actionType.value=sendDelayType;//send delay type
	window.opener.document.procForm.alertActionType.value=sendAlertType;//send alarm type
	window.opener.document.procForm.actionApplication.value=sendDA;//send Delay application program
	window.opener.document.procForm.alertActionApplication.value=sendAA;//send Alarm application program
	window.opener.document.procForm.variable.value=sendVariable;//send delay variable select choice
	window.opener.document.procForm.alertVariable.value=sendAlertVariable;//send alarm variable select choice
	window.opener = null;
	window.close();
}
...
function displayDiv(){
   ...
   $("intervalMin").value=(aInterval-parseInt(aInterval/(24*60))*24*60)%60 
    $("delayApplication").value=window.opener.document.procForm.exActionName.value;
   $("alertApplication").value=window.opener.document.procForm.exAlertActionName.value;
}
...
function variableSelect1(){
    ...
    for(i=0;i<obj.length;i++){
		if(obj[i].innerHTML==window.opener.document.procForm.variable.value){
			obj[i].selected=true;
...
function variableSelect2(){
    ...
    for(i=0;i<obj.length;i++){
		if(obj[i].innerHTML==window.opener.document.procForm.alertVariable.value){
			obj[i].selected=true;
