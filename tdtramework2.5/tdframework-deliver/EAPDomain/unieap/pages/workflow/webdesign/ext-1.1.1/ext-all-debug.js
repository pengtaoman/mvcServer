...
Ext.extend(Ext.data.Connection, Ext.util.Observable, {
    ...
    timeout : 3*60000,//set timeout three minute
...
//    },
	 ...
	 applySort : function(){     //锟斤拷锟斤拷 applySort
          if(this.sortInfo && !this.remoteSort){
              var s = this.sortInfo, f = s.field;
              var st = this.fields.get(f).sortType;
              var fn = function(r1, r2){
                  var v1 = st(r1.data[f]), v2 = st(r2.data[f]);
                  // 锟斤拷锟�:锟睫革拷锟斤拷锟斤拷锟斤拷锟斤拷锟届常锟斤拷Bug
                  if(typeof(v1) == "string"){ //锟斤拷为锟街凤拷
                       return v1.localeCompare(v2);//锟斤拷锟斤拷 localeCompare 锟饺较猴拷锟斤拷锟街凤拷, Firefox 锟斤拷 IE 锟斤拷支锟斤拷
                  }
                  // 锟斤拷咏锟斤拷锟�
                  return v1 > v2 ? 1 : (v1 < v2 ? -1 : 0);
          };
...
Ext.extend(Ext.form.TextField, Ext.form.Field,  {
	...
	hideLabel:function(){
	var inputDiv=this.el.dom;
		var label=inputDiv.parentNode.previousSibling;
