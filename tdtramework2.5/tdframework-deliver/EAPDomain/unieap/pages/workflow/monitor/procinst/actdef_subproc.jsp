...
<table width="300" valign="left" bgcolor="#EEEEEE">
			<tr bgcolor="#EFEFEF" valign="middle" style="font-weight:bold;">
				<td class="main_label_td" valign="middle" ><bean:message bundle="uniflow" key = "workflow.monitor.procinst.common"/></td>
			...
			<tr>
				...
				<td class="main_label_td" valign="middle" nowrap>子流程节点</td>
			</tr>
			<tr bgcolor="#EFEFEF" valign="middle" style="font-weight:bold;">
			...
			<tr>
				<td class="main_label_td" valign="middle" nowrap><bean:message bundle="uniflow" key = "workflow.activity.defination.couple"/></td>
				<td class="main_label_td" valign="middle" nowrap><%=CommonInfoManager.getCoupleInfo(actdefInfo.getCoupleType(),session)%>&nbsp;</td>
			</tr>			
						<tr bgcolor="#EFEFEF" valign="middle" style="font-weight:bold;">
