...
<form action="svgmonitor.do">
 <uniflow:m_table style="main_title_table">
  <tr>
    <td nowrap class="text_title" ><%=(String) request.getSession().getAttribute("procTitle")%></td>
...
<uniflow:m_table style="main_list">
	<tr>
		...
		<embed id="svg" width="<%=(String)request.getSession().getAttribute("maxX")%>" height='<%=(String)request.getSession().getAttribute("maxY")%>'
			type="image/svg+xml"
			PLUGINSPAGE="http://www.adobe.com/svg/viewer/install/"
			src='<%=request.getContextPath()%>/displaySvg?print=oldmprocdef'>
		</embed></div>
		</td>
	</tr>
</uniflow:m_table>
