...
function _showFullScreenPreLoader()
{
	...
	if(obj!=null)
	{
		...
		ht += "<tr><td height='100%' valign='middle' align='center'><img src='<%=path%>/unieap/pages/workflow/extension/report/images/preLoader.gif' width='200' height='150' border='0'/><\/td><\/tr>";
		ht += "<\/table>";
		obj.innerHTML = ht;
	}
}
