...
<html>
  <head>
	...
	<script type="text/javascript">
			...
			{	
				...
				{
					prepareWFStaticWin();
					WFInstanceStatForm.domNode.target = getWFStaticWinName();
					WFInstanceStatForm.domNode.submit();
				}
			}
	</script>
    <title>QueryPage_WFInstance</title>  
  ...
  <body class="unieap" style="margin:0px;background-color:#F1F7FE">
				...
				==================================================================================================================
				  -->
				<div dojoType="unieap.layout.ContentPane" title="流程实例运行统计分析" style="vertical-align:top; text-align:center;">
					...
					<tr>
						<td height="24"></td>
						<td style="font-size:14px; text-align:left; padding-left:5%;padding-right:5%; line-height:20px;">■&nbsp;&nbsp;<b>流程实例运行统计分析</b>以流程实例为单位，统计指定流程分类下各个流程实例在指定时间区间内的运行情况，包括：实例名称、状态、创建时间、完成时间、计划完成时间、延误时间、流程发起人、工作项数，以及上述各项数据的汇总。</td>
						<td></td>
					</tr>
					<tr>
						<td height="24"></td>
					...
					<tr>
						<td colspan="3" align="center">
							<!-- Set Start -->
							<form name="WFInstanceStatForm" id="WFInstanceStatForm" jsId="WFInstanceStatForm" dojoType="unieap.form.Form" method="post" action="<%=path%>/ShowWFStat.do?newReport=true">
							<input type="hidden" name="reportId" value="d554b5f6-aaca-4c1f-ac05-25e29efce106" />
