...
<title>创建新实例</title>
 ...
 function reload()
{
  location.href = "<%=request.getContextPath()%>/procdeflist.do";
}
 function refresh()
{
  location.href = "<%=request.getContextPath()%>/procdeflist.do";
...
function create(){
  ...
  var openURL = "<%=request.getContextPath()%>/createProcInst.do?selectedID="+selectedID+"&needCreatRole="+needCreatorRole;                                          
...
function search_onclick(){
  ...
  document.forms[0].procdefName.value = document.getElementById('condition').value;
...
<uniflow:m_body onload="javascript:itemChanged()">
	<uniflow:m_form action="procdeflist.do">
  ...
  <table border="1"   bordercolordark="#00eeFF" bordercolorlight="#0000cc" cellpadding="2" cellspacing="0" class="T_song12bk2" width="100%" bgcolor="#FFFFFF">
    ...
    <tr> 
      <td align="center" height="80">&#21517;&#31216;&#65306; 
        <input id="condition" type="text" name="searchCondition" size="20" maxlength="40"/>
		...
		<div id="main">
				...
				<tr>
					<td align="right" valign="middle" class="main_table2_td2">
						<table height="28" border="0" cellpadding="0" cellspacing="0"
							...
							<td height="25" valign="middle" nowrap class="main_label_td"><uniflow:commonbutton refreshAction='javascript:refresh()'	customAction='javascript:custom_window()' />
								</td>
							</tr>
						</table>
					</td>
			...
			<uniflow:m_table style="main_list">
				...
				<uniflow:m_order_th name="category"
					value="workflow.procdef.category"
				...
				<logic:iterate id="procdef" name="procdeflistForm" property="list"
					type="com.neusoft.uniflow.api.def.NWProcDef" indexId="index">
					<uniflow:m_list_tr row="<%=index.intValue()%>">
						<td width="25" align="center" valign="middle" class="main_list_td">
							<html:radio property="selectedItem"
								value="<%=procdef.getID() + String.valueOf('&')
							+ String.valueOf('v') + String.valueOf('=')
			...
			<html:hidden property="procdefName" />
		</div>
	</uniflow:m_form>
</uniflow:m_body>
</html:html>
