...
<frameset cols="220,*,0" frameborder="0" framespacing="0" border="0" >
  <frame name="apptree" src="<%=request.getContextPath()%>/mulappsel.do?activityid=<%=aid%>&actiontype=wi&opstring=<%=opstring%>" marginwidth="0" marginheight="0" frameborder="0" noresize framespacing="0">
  <frame name="application" src="" marginwidth="0" marginheight="0" frameborder="0" noresize framespacing="0">
