...
function set_notify(){
    var openURL = "<%=request.getContextPath()%>/notifyinfo.do?workitemID=<%=wid%>&&action=open";
    var width = 432;
    var height = 350;
...
<body class="open_body" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="javascript:afterload()">
