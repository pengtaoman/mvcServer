...
<tr valign="middle"> 
<td align="right">
<img src="<%=request.getContextPath()%>/unieap/pages/form/css/images/button_priview.gif" onclick="viewFormPage()"/>
<img src="<%=request.getContextPath()%>/unieap/pages/form/css/images/button_back.gif" onclick="javascript:history.back()"/>
