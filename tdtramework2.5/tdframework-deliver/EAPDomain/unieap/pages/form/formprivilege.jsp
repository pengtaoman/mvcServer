                ...
                <tr height="3%">
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_base" >
                    <tr>
                      ...
                      </span><img src="css/images/search.gif" width="16" height="16" align="absmiddle" onclick="search()"></td>
                      <td width="25" align="right"><img src="css/images/refresh.gif" style="cursor:hand" alt='<%=MessageUtil.getString("form.privilege.refresh",session) %>' width="16" height="16" onclick="refreshOrgTree('privilege')"></td>
                    </tr>
                  </table>
                  </td>
                      ...
                      <DIV  onselectstart="return false" id="orgTreeSelectPanel" style="position:relative;top:0;left:0;width:240;height:100%;border:solid #b9b9b9 1px;overflow:auto" onscroll="clickScroll();return false" >
				        <div  style="font-size:12;">
				           ...
				           <span onclick="showBranch(this)" id="roleparent" style="vertical-align:middle;text-align:center">
				              <img src="css/images/close.gif"/>&#160;&#160;<img src="css/images/organise.gif" onclick="event.cancelBubble=true" style="vertical-align:middle;text-align:center"/>
