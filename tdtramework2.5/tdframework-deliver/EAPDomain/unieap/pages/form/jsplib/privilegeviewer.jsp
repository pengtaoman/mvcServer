...
if (flag)
 {
location.href="<%=request.getContextPath()%>/privilegeviewerturnPage.do?page="+num+"&isNowSession='true'";
 }
...
{
location.href="<%=request.getContextPath()%>/privilegeviewer.do?sortColumnName="+sortColumnName+"&isNowSession='true'";
}
...
location.href="<%=request.getContextPath()%>/privilegelist.do?formID="+getSelectedItemID();
}

function goToPage(pageCode){

location.href="<%=request.getContextPath()%>/privilegeviewerturnPage.do?page="+pageCode+"&isNowSession='true'";
}
