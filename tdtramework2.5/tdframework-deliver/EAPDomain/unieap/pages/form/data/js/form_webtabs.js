...
NSFormPages.prototype.toString = function() {
  ...
  s += '<div id="f_cmd_div_left" style="position: relative; top: 40px; text-align: center; display:block;">';
  s += getMenuHandler().createLeftCmdDiv(2,2);  
  s += '</div>';
  s += '</td><td>';

  s += "<table border='0' cellpadding='0'  cellspacing='0' >"; 
  s += "<tr class='tab_div_tr'><td>";
  ...
  s += '<td><div id="f_top_tab_div" ><table cellpadding="0" cellspacing="0" class="main_tab_table_head_my"><tr>';
  ...
  s += '<td align="right" valign="bottom" style="padding-bottom:3px;">';
  s += "<div id='f_turn_div_top' style='visibility:hidden;'>"
...
//////////////////
  ...
  s += "<table cellpadding='0'  cellspacing='0' width='100%'><tr class='tab_div_tr'>";
  ...
  for (i = 0; i < this._tabs.length; i++) {
    ...
    s += '<td valign="top" align="left" nowrap >'
       ...
       + '<td width="3"><img src="unieap/pages/form/data/images/tab/main_unchecked_left.gif" width="3" height="28"></td>'
       //+ "<td width='3'><img src='unieap/pages/form/data/images/tab/main_unchecked_left.gif' width='3' height='28'></td>"
       + '<td align="center" nowrap class="main_tab_unchecked_center2">'+this._tabs[i].text+'</td>'
       + '<td width="3" align="right"><img src="unieap/pages/form/data/images/tab_botton/main_unchecked_right.gif" width="3" height="28"></td>'
       + '</table></div></td>';
  ...
  s += "<div id='f_turn_div_bottom' style='visibility:hidden;padding-top:3px;'>"
  s += getMenuHandler().createTurnMenu();
  s += '</div></td>';  
...
function NSFormTab(text,icon) {
  ...
  NSFTHandler.f_tab_ids[NSFTHandler.idCounterTab-1]=this.id;
  NSFTHandler.f_tab_names[NSFTHandler.idCounterTab-1] = this.text;
...
NSFormTab.prototype.toString = function(){
  ...
  s += "<table height='27' border='0' cellpadding='0' cellspacing='0' class='table_base'>"
    + "<tr><td width='3'><img src='unieap/pages/form/data/images/tab/main_unchecked_left.gif' width='3' height='28'></td>"
    + "<td align='center' nowrap class='main_tab_unchecked_center' no="+i+">"+ this.text + "</td>"
    + "<td width='3' align='right'><img src='unieap/pages/form/data/images/tab/main_unchecked_right.gif' width='3' height='28'></td>"
    + "</tr></table>"
  s += "</div>";
  s += "</td>";
  return s;
...
function f_activate_tab(tab){
  //debugger;
  var pageNo_div = document.all.pageNo_div;//getElementById("pageNo_div");
  if(pageNo_div){
	  for(var i=0;i<pageNo_div.length;i++){
	  	pageNo_div[i].innerHTML = (tab+1)+"/"+NSFTHandler.idCounterTab;
	  }  	
  }
  ...
  for(i=0;i<total_tabs;i++){
  	if(i!=tab){
	 	...
	 	f_page_div.style.display = "none";
	  	...
	  	//top tab
	  	f_temp_top_tab_div.childNodes[0].childNodes[0].src = "unieap/pages/form/data/images/tab/main_unchecked_left.gif";
	  	f_temp_top_tab_div.childNodes[1].className = "main_tab_unchecked_center";
	  	f_temp_top_tab_div.childNodes[2].childNodes[0].src = "unieap/pages/form/data/images/tab/main_unchecked_right.gif";  
	  	//botton tab
	  	f_temp_bottom_tab_div = f_temp_bottom_tab_div.childNodes[0].childNodes[0].childNodes[0];
	  	f_temp_bottom_tab_div.childNodes[0].childNodes[0].src = "unieap/pages/form/data/images/tab_botton/main_unchecked_left.gif";
	  	f_temp_bottom_tab_div.childNodes[1].className = "main_tab_unchecked_center2";
	  	f_temp_bottom_tab_div.childNodes[2].childNodes[0].src = "unieap/pages/form/data/images/tab_botton/main_unchecked_right.gif";     	
  	}else{
  		...
  		f_temp_top_tab_div.childNodes[0].childNodes[0].src = "unieap/pages/form/data/images/tab/main_checked_left.gif";
  		f_temp_top_tab_div.childNodes[1].className = "main_tab_checked_center";
  		f_temp_top_tab_div.childNodes[2].childNodes[0].src = "unieap/pages/form/data/images/tab/main_checked_right.gif";

    
  		f_temp_bottom_tab_div = f_temp_bottom_tab_div.childNodes[0].childNodes[0].childNodes[0];
  		f_temp_bottom_tab_div.childNodes[0].childNodes[0].src = "unieap/pages/form/data/images/tab_botton/main_checked_left.gif";
  		f_temp_bottom_tab_div.childNodes[1].className = "main_tab_checked_center2";
  		f_temp_bottom_tab_div.childNodes[2].childNodes[0].src = "unieap/pages/form/data/images/tab_botton/main_checked_right.gif";    	
  	} 	
  }
  NSFTHandler.f_current_tab = tab; 
  ...
  if(no==1)
    {  
      ...
      else
      {
         ...
         //document.getElementById("top_tab_"+NSFTHandler.f_tabs_end).style.display="block"
         document.getElementById("top_tab_"+startDisNo).style.display="none"
         //document.getElementById("bottom_tab_"+NSFTHandler.f_tabs_end).style.display="block"
  ...
  if(no==-1)
    {
      if(startDisNo==0)
       ...
       {              
            //document.getElementById("top_tab_"+NSFTHandler.f_tabs_end).style.display="none"; 
            //document.getElementById("bottom_tab_"+NSFTHandler.f_tabs_end).style.display="none"; 
            NSFTHandler.f_tabs_end = endDisNo-1
...
function calctabinfo(){
	...
	for(i=NSFTHandler.f_tabs_start;i<total_tabs;i++){
      	...
      	if(f_temp_width > f_cur_width - 130 - f_top_cmd_div_length){
