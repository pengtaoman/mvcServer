			  ...
			  <tr>
			    ...
			    <table class="button_table" cellspacing="0">
			      <tr align="right">
			        ...
			        <td class="button_td"><input type="button" name="cancel" value='<%=MessageUtil.getString("form.button.close",session) %>' class="button_normal" onclick="javascript:parent.close()"></td>
			      </tr>
			    </table>
			    </td>
			  </tr>
