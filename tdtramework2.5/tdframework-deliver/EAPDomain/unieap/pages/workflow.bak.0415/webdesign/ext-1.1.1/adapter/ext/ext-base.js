 ...
 */
    ...
    Ext.lib.Ajax = {
        request : function(method, uri, cb, data, options) {
            ...
            return this.asyncRequest(method, uri, cb, data,isasynchronous);
        },
        ...
        asyncRequest:function(method, uri, callback, postData,asyncRequest)
        {
            ...
            if (!o) {
                ...
                o.conn.open(method, uri, asyncRequest);
        ...
        createResponseObject:function(o, callbackArg)
        {
            ...
            //session timeout 
            if(obj.responseText.indexOf("<!-- THE NOTE OF SESSION-TIMEOUT FOR PARTREFRESH -->")>=0){
