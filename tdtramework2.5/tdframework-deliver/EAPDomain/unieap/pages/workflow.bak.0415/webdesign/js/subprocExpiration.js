...
function setParentValue(){
	...
	window.opener.document.subprocNodeForm.exActionName.value =sendExAn;//send Delay Time
	window.opener.document.subprocNodeForm.exAlertActionName.value =sendExAAN;//send Delay Time
	window.opener.document.subprocNodeForm.duration.value =sendDelayTime;//send Delay Time
	window.opener.document.subprocNodeForm.alertDuration.value=sendAlertTime;//send Alert Time
	window.opener.document.subprocNodeForm.alertActionInterval.value=sendIntervalTime;//send alarm Interval Time
	window.opener.document.subprocNodeForm.varOrDur.value=sendDelayVar;//send delay radio variable choice
	window.opener.document.subprocNodeForm.alertVarOrDur.value=sendAlertVar;//send alerm radio variable choice
	window.opener.document.subprocNodeForm.actionType.value=sendDelayType;//send delay type
	window.opener.document.subprocNodeForm.alertActionType.value=sendAlertType;//send alarm type
	window.opener.document.subprocNodeForm.actionApplication.value=sendDA;//send Delay application program
	window.opener.document.subprocNodeForm.alertActionApplication.value=sendAA;//send Alarm application program
	window.opener.document.subprocNodeForm.variable.value=sendVariable;//send delay variable select choice
	window.opener.document.subprocNodeForm.alertVariable.value=sendAlertVariable;//send alarm variable select choice
	window.opener = null;
	window.close();
}
...
function displayDiv(){
   ...
   $("delayApplication").value=window.opener.document.subprocNodeForm.exActionName.value;
   $("alertApplication").value=window.opener.document.subprocNodeForm.exAlertActionName.value;
}
...
function variableSelect1(){
    ...
    for(i=0;i<obj.length;i++){
		if(obj[i].innerHTML==window.opener.document.subprocNodeForm.variable.value){
			obj[i].selected=true;
...
function variableSelect2(){
    ...
    for(i=0;i<obj.length;i++){
		if(obj[i].innerHTML==window.opener.document.subprocNodeForm.alertVariable.value){
			obj[i].selected=true;
