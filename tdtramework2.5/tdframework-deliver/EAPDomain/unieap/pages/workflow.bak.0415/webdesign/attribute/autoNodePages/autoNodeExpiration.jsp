...
<script type="text/javascript" src="<%=WorkflowManager.getWorkflowPath()%>/webdesign/js/autoNodeExpiration.js"></script>
	...
	<div>
		<table class="main_label_table">
			<tr>
		    	...
		    	<td><input type="radio" name="delayType" style="" class="rodio" <%=request.getParameter("aType").equals("0")?"checked":""%> value="0" onclick="displayDelayApp()">继续</input>
				...
				<input type="radio" name="delayType"  style="" class="rodio" <%=request.getParameter("aType").equals("4")?"checked":""%> value="4" onclick="displayDelayApp()">回退</input>
