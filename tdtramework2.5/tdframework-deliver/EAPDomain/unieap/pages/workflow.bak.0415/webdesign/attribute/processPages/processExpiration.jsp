...
<script type="text/javascript" src="<%=WorkflowManager.getWorkflowPath()%>/webdesign/js/processExpiration.js"></script>
...
<fieldset style="width:500px;">
	...
	<div>
		<table class="main_label_table">
			<tr>
		    	...
		    	<td><input type="radio" name="delayType" style="display:none" class="rodio" <%=request.getParameter("aType").equals("0")?"checked":""%> value="0" onclick="displayDelayApp()"></input>
				...
				<input type="radio" name="delayType"  style="display:none" class="rodio" <%=request.getParameter("aType").equals("4")?"checked":""%> value="4" onclick="displayDelayApp()"></input>
	...
	<div id="application1" style="display:none">
		<table class="main_label_table">
			<tr>
				<td style="height:30px;width:90px" >应用程序:</td>
				<td><input type="text" id="delayApplication" class="input_text"  value='' style="width:250px"></input>&nbsp;<input type="button" class="button_small" name="openDelayApplication" onclick="openApp(event)" value="浏览">&nbsp;<input type="button" class="button_small" onclick="clearUp1()" value="取消" >
				</td>
			</tr>
		</table>
	</div>
...
<fieldset style="width:500px;">
		...
		<table class="main_label_table">
			<tr>
				...
				<td>工作日<input type="text" class="input_text"  id="intervalDay" style="width:40px" onkeypress="return ieNum(event);"  onkeyup="ffNum(this.id)"></input>
					小时<input type="text" class="input_text" id="intervalHour" style="width:40px" onkeypress="return ieNum(event);"  onkeyup="ffNum(this.id)"></input>
					分钟<input id="intervalMin" type="text" class="input_text" style="width:40px" onkeypress="return ieNum(event);"  onkeyup="ffNum(this.id)"></input></td>
			</tr>
		</table>
	</div>
	<div>
	...
	<div id="application2" style="display:none">
		<table class="main_label_table">
			<tr>
				<td style="height:30px;width:90px">应用程序:
				</td>
				<td>
				    <input type="text" id="alertApplication" class="input_text"  value=''  style="width:250px"></input>&nbsp;<input type="button" class="button_small" name="openAlertApplication"onclick="openApp(event)" value="浏览">&nbsp;<input type="button" class="button_small" onclick="clearUp2()" value="取消" >
				</td>
			</tr>
		</table>
	</div>
