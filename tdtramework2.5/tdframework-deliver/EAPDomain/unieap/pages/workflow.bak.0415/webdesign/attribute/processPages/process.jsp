		...
		<div class="main_label_outline" style="width: 540px">
			...
			<table style="width: 510px" class="main_label_table">
				<tr>
					...
					<td>
						<html:text property="builder" style="width:80px;" disabled="false"
							styleClass="input_text"
							value='<%=((ProcForm) request.getAttribute("ProcForm"))
										.getBuilder()%>'>
						</html:text>
					...
					<td>
						<html:text property="versionName" style="width:80px;"
				...
				<tr>
					...
					<td>
						<html:text property="buildTime" style="width:80px;"
							disabled="true" styleClass="input_text"
							value='<%=((ProcForm) request.getAttribute("ProcForm"))
										.getBuildTime()%>'>
						</html:text>
					...
					<td>
						<html:text property="modifiedTime" style="width:80px;"
							disabled="true" styleClass="input_text"
							value='<%=((ProcForm) request.getAttribute("ProcForm"))
										.getModifiedTime()%>'>
						</html:text>
