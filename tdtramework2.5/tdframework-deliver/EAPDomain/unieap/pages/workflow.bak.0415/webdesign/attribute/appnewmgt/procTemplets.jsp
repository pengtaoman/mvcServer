...
Ext.onReady(function(){   
    ...
    var ctree = new tree.TreePanel('cbody', {
        ...
        dataUrl:'<%=request.getContextPath()%>/subrprocList.do?method=getCategory',
...
function commitValue(){
		         ...
		         //window.opener.document.subprocNodeForm.subprocName.value = appName;
		         //window.opener.document.subprocNodeForm.subproc.value = appId;
	window.close();
	window.opener.location.href = "<%=WorkflowManager.getWorkflowPath()%>/webdesign/procmodify/procmodifydetail.jsp?selectedID="+appId+"&newVersion=true";
}
      </script> 
</head>
<body>
...
<table style="width:240px" class="main_button">
       <tr>
