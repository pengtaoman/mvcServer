		...
		<div dojoType="unieap.layout.AdaptivePane" autoHeight=true height="100%">
			<div dojoType="unieap.layout.TitlePane" open="true" title="异常应用程序管理" style="height:100%" jsId="MainContent"> 
				<div dojoType="unieap.layout.TabContainer" jsId="tabcontainer" style="height:100%;width:100%;">
					<div dojoType="unieap.layout.ContentPane" title="流程应用程序(<%=procNum%>)" href="<%=path%>/unieap/pages/workflow/management/applicationmgt/errorProcApp.jsp"></div>
					<div dojoType="unieap.layout.ContentPane" title="节点应用程序(<%=actNum%>)" href="<%=path%>/unieap/pages/workflow/management/applicationmgt/errorActinstApp.jsp"></div>
					<div dojoType="unieap.layout.ContentPane" title="工作项应用程序(<%=workitemNum%>)" href="<%=path%>/unieap/pages/workflow/management/applicationmgt/errorWorkitemApp.jsp"></div>
				</div>
			</div>
		</div>
	</div>
