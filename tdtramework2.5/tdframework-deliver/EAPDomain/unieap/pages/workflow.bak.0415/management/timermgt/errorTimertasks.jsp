...
<html>
	...
	<div dojoType="unieap.layout.AdaptiveContainer" height="100%">
		<div dojoType="unieap.layout.AdaptivePane" autoHeight=true height="100%">
			<div dojoType="unieap.layout.TitlePane" open="true" title="异常超时任务管理" style="height:100%" jsId="MainContent"> 
				<div dojoType="unieap.layout.TabContainer" jsId="tabcontainer" style="height:100%;width:100%;">
					<div dojoType="unieap.layout.ContentPane" title="流程超时任务(<%=procNum%>)" href="<%=path%>/unieap/pages/workflow/management/timermgt/errorProctimertask.jsp"></div>
					<div dojoType="unieap.layout.ContentPane" title="节点超时任务(<%=actNum%>)" href="<%=path%>/unieap/pages/workflow/management/timermgt/errorActtimertask.jsp"></div>
					<div dojoType="unieap.layout.ContentPane" title="工作项超时任务(<%=workitemNum%>)" href="<%=path%>/unieap/pages/workflow/management/timermgt/errorWorkitemtimertask.jsp"></div>
				</div>
			</div>
		</div>
	</div>
