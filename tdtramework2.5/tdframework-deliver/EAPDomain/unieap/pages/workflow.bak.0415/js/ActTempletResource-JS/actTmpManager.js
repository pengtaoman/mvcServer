 ...
 */
var Action_GetCategory = WEB_APP_CONTENT + "/act_templet.do?method=getCategory";
var Action_AddCategory = WEB_APP_CONTENT + "/act_templet.do?method=addCategory";
var Action_DeleteCategory = WEB_APP_CONTENT
		+ "/act_templet.do?method=deleteCategory";
var Action_ModifyCategory = WEB_APP_CONTENT
		+ "/act_templet.do?method=modifyCategory";
...
Ext.onReady(function() {
	...
	ctree.on('click', function() {
		...
		// alert(contextPath);
		window.open(contextPath + "/acttmpresource.do?parentIdStore="
				+ parentIdStore + "&deleteId=all", "actTmpResource");
	});
