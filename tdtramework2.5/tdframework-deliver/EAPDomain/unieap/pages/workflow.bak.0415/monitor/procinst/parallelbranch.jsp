...
<uniflow:m_form action="parallel.do">
...
<uniflow:p_content_comm_wrapper width="100%">
   <uniflow:p_content_table>
    ...
    <uniflow:p_content_tr>
	  <td class="main_label_td" valign="middle" nowrap>
	     <uniflow:p_content_table>
           <logic:iterate id="actpara" name="parallelBranchForm" property="list" type="com.neusoft.uniflow.web.monitor.procinst.beans.ActParaBean" indexId="index">
	       <uniflow:p_content_tr>
	         <td class="main_label_td" valign="middle" nowrap>
	           <html:multibox name="parallelBranchForm" property="checked">
