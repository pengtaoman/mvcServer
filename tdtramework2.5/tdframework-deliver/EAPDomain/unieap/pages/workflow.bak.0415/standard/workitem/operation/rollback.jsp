...
<uniflow:m_form action="rollback.do">
<uniflow:p_title>
...
<uniflow:p_content_comm_wrapper width="100%">
  ...
  <uniflow:p_content_table>
    <uniflow:p_content_tr>
        ...
        <td class="main_label_td" valign="middle" nowrap><bean:write name ="rollBackForm" property="rollBackActName"/><html:hidden property="runningAct"/></td>
        
   </uniflow:p_content_tr>
   
   <uniflow:p_content_tr>
					<td class="main_label_td" valign="middle" nowrap>操作方式</td>
					<td>
						<table border='0'>
						   <tr><td class="main_list_td" valign="middle" width="30">
								<html:radio property="rollbacktype" value="0"></html:radio>
						   		</td>
						   		<td class="main_list_td" valign="middle">不回到原点</td>
						   </tr> 
						   <tr><td class="main_list_td" valign="middle" width="30">
								<html:radio property="rollbacktype" value="1"></html:radio>
						   		</td>
						   		<td class="main_list_td" valign="middle">回到原点</td>
						   </tr>
						</table>
					</td>
				</uniflow:p_content_tr>
