...
function tab_onclick(){
	location.href="<%=request.getContextPath()%>/setActparti.do?activityid="+document.forms[0].actPartiId.value;
}
function addSelect(){
...
<uniflow:m_form action="setcsActparti.do">
<table width="440"  border="0" cellpadding="0" cellspacing="0" >
 ...
 <tr>
 	<td>
 		<uniflow:tab>
 			<uniflow:tabElement selected="false" messageKey="workflow.participant.zhusong" action="javascript:tab_onclick()"></uniflow:tabElement>
 			<uniflow:tabElement selected="true" messageKey="workflow.participant.chaosong" action="javascript:tab_onclick()"></uniflow:tabElement>
 		</uniflow:tab>
 	</td>
 </tr>
		...
		<table width="440" height="260" border="0" cellspacing="0">
		   <tr><td height="260"><table  border="0" cellspacing="0">
				...
				<tr><td width="200" align="right" height="240">
					<iframe id="actsel" src="oneactorsel.do?selType=1" width="195" height="240" scrolling="yes" frameboder="0"></iframe>
				</td></tr>
		   </table></td>
