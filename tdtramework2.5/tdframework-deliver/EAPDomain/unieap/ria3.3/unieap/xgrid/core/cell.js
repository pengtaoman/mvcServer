...
dojo.declare("unieap.xgrid.Cell", null, {
	...
	_changeStyle: function(rowData,rowIndex,m,cellIndex){
		if(rowData[rowIndex]._styles && "undefined" != typeof(rowData[rowIndex]._styles[cellIndex]) && rowData[rowIndex].identifierNO[cellIndex] == cellIndex){
			var styles = m[2]+";"+rowData[rowIndex]._styles[cellIndex];
			m[2] = styles;
		}
		return m;
	},
