...
dojo.declare("unieap.layout.BorderPane",[unieap.layout.Container,dijit._Templated],{ 
	...
	postCreate: function() {
		...
		if(this.wrap && this.region != 'center') {
		...
		!this.fixed && this.connects.push(dojo.connect(this.splitNode, 'onmousedown', this, '_startMove'));
