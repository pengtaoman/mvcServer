...
<html>
    <head>
        ...
        <%@ include file="/unieap/ria3.3/pages/config.jsp" %>
         <script type="text/javascript" src="test_pojoPersis.js"></script>
	</head>
    <body class="unieap">
	     <div dojoType="unieap.layout.TitlePane" title="人员编辑" >
		      <form id="org.form" jsId="orgForm" dojoType="unieap.form.Form" binding="{store:'empDataStore'}">
			   ...
			   <div id="grid" jsId="grid" dojoType="unieap.grid.Grid" width="auto" height="300px"
					...
					<toolbar  paging="{url:'/RIATest.do?method=testLoadPoJo',onPagingModified:onPM}">
					</toolbar>   
				</div>
				<script>
					function onPM(store,binding){
						if(confirm("保存修改？")){
	 						binding.save({url:'/DCTest.do?method=testSavePoJo'});
	 					}
					}
				</script>
		</div>
