...
<body class="unieap">
<font color="red">※导出默认只支持3种选项，服务器端导出可自己开发，客户端导出方式调查中</font>
<div dojoType="unieap.xgrid.Grid" id="empGrid" width="500px" height="300px"
	...
	<toolbar id="toolbar01" paging='{clientPaging:true,userPageSize:[5,10],onBeforePaging:beforePage}' 
