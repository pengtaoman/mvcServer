...
<body class="unieap">
		 <div dojoType='unieap.tree.Tree' label="地市" treeEditor="{allowBlank:true}"  style='height:200px;width:400px;overflow-x:hidden;overflow-y:auto' id='menuNaviTree' " binding="{'leaf':'leaf','id':'id','store':'tree01','label':'label','parent':'parent',query:{name:'parent',relation:'=',value:''}}"></div>
          <div dojoType="unieap.layout.TitlePane" flexible="false" width="400px" height="200px" title="编辑说明">
                                           点击树中的节点可进入编辑状态。
         </div>
</body>
</html>	
